      ...
      <div className="grid lg:grid-cols-2 gap-20 items-start">
        ...
        >
          <div>
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">Reserved for <br /> <span className="text-primary italic">Great Conversations.</span></h2>
          ...
          <div className="space-y-6">
            {[
              ...
              <motion.div 
                key={idx}
                whileHover={{ x: 10 }}
                className="flex items-center gap-6 p-6 bg-white rounded-[2rem] shadow-sm border border-border/50 group cursor-pointer"
              >
                <div className={cn("p-4 rounded-2xl text-white transition-all shadow-lg", item.color)}>
                  {item.icon}
                </div>
                <div>
          ...
          <div className="relative p-10 bg-gray-900 rounded-[3rem] text-white overflow-hidden">
            <div className="relative z-10">
              <h4 className="text-2xl font-bold mb-4">Official Kalsang Club</h4>
              <p className="text-white/50 mb-8 text-sm">Join 10,000+ members getting exclusive dining offers every week.</p>
              <div className="flex gap-3">
                <input 
                  type="email" 
                  placeholder="john@doe.com" 
                  className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 flex-grow focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all placeholder:text-white/20"
                />
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-border/50 relative"
        >
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className={cn("rounded-2xl border-gray-100 h-16 px-6 focus:border-primary transition-all", errors.name && "border-red-500 bg-red-50")} 
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className={cn("rounded-2xl border-gray-100 h-16 px-6 focus:border-primary transition-all", errors.phone && "border-red-500 bg-red-50")} 
                    />
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    type="email" 
                    className={cn("rounded-2xl border-gray-100 h-16 px-6 focus:border-primary transition-all", errors.email && "border-red-500 bg-red-50")} 
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    ...
                    className={cn("rounded-3xl border-gray-100 min-h-[160px] p-6 resize-none focus:border-primary transition-all", errors.message && "border-red-500 bg-red-50")} 
                  />
                ...
                <Button 
                  ...
                  className="w-full h-20 rounded-[2rem] text-lg font-bold shadow-2xl shadow-primary/30 flex gap-3 group relative overflow-hidden"
                >
                  <AnimatePresence mode="wait">
                    {formState === 'loading' ? (
                      <motion.div 
